...
class Interface(models.Model):
    ip_address = models.IPAddressField(verbose_name = 'IP адрес', blank=True, null=True)
...
class Profile(models.Model):
    ...
    person = models.ForeignKey(Person, verbose_name='Персона', null=True)
    personinterface = models.ForeignKey(PersonInterface, verbose_name='Личные настройки', null=True)
    interface = models.ManyToManyField(Interface, verbose_name='Связь с интерфейсами', null=True)
    accounts = models.ManyToManyField(Accounts, verbose_name='Связь с аккаунтами', null=True)
...
class APILogger(models.Model):
    ...
    ip = models.IPAddressField(verbose_name = 'IP адрес', db_index=True)
...
class Films(models.Model):
    ...
    release = models.ManyToManyField(FilmsReleaseDate, null=True)
    ...
    budget = models.ForeignKey(Budget,verbose_name='Бюджет', null=True)
    production = models.ManyToManyField(ProductionsCo, verbose_name='Компания призводитель', null=True)
    ...
    distributor = models.ManyToManyField(Distributors, verbose_name='Дистрибьютор', null=True)
    images = models.ManyToManyField(Images, verbose_name='Постеры, слайды', null=True)
...
class FilmsVotes(models.Model):
    ...
    user = models.ForeignKey(Profile, verbose_name='Юзер')
...
class RelationFP(models.Model):
    ...
    status_act = models.ForeignKey(StatusAct)
...
class FilmsSources(models.Model):
    # связи с источниками
    id_films = models.ForeignKey(Films, verbose_name='КиноИнфо')
    source = models.ForeignKey(ImportSources, verbose_name='Источник')
...
class AlterStreetType(models.Model):
   value =  models.ForeignKey(StreetType, verbose_name='Оригинальный тип улицы')
...
class Cinema(models.Model):
    ...
    cinema_circuit = models.ForeignKey(CinemaCircuit, verbose_name='Сеть кинотеатров', null=True)
    metro = models.ManyToManyField(Metro, verbose_name='Станция метро', null=True)
    street_type = models.ForeignKey(StreetType, verbose_name='Тип улицы', null=True)
...
class Hall(models.Model):
    ...
    cinema = models.ForeignKey(Cinema, verbose_name='Кинотеатр')
...
class Demonstration(models.Model):
    ...
    place = models.ForeignKey(Hall, verbose_name='Место сеанса')
...
class HallsSources(models.Model):
    ...
    id_hall = models.ForeignKey(Hall, verbose_name='Зал')
    source = models.ForeignKey(ImportSources, verbose_name='Источник')
...
class SourceCinemas(models.Model):
    source_id = models.CharField(max_length=256, verbose_name='ID источника')
    source_obj = models.ForeignKey(ImportSources, verbose_name='Источник')
    city = models.ForeignKey(SourceCities, verbose_name='Город источника')
    cinema = models.ForeignKey(Cinema, verbose_name='Кинотеатр')
...
class SourceHalls(models.Model):
    source_id = models.CharField(max_length=256, verbose_name='ID источника')
    source_obj = models.ForeignKey(ImportSources, verbose_name='Источник')
    cinema = models.ForeignKey(SourceCinemas, verbose_name='Зал источника')
...
class SourceFilms(models.Model):
    ...
    rel_profile = models.ForeignKey(Profile, verbose_name='Кто связал', null=True)
...
class SourceSchedules(models.Model):
    source_id = models.CharField(max_length=256, verbose_name='ID источника', db_index=True)
    source_obj = models.ForeignKey(ImportSources, verbose_name='Источник')
    film = models.ForeignKey(SourceFilms, verbose_name='Фильм источника')
    cinema = models.ForeignKey(SourceCinemas, verbose_name='Кинотеатр источника')
...
class Torrents(models.Model):
    ...
    source_obj = models.ForeignKey(ImportSources, verbose_name='Источник', null=True)
...
class TorrentsUsers(models.Model):
    torrent = models.ForeignKey(Torrents, verbose_name='Торрент')
...
class Awards(models.Model):
    awards = models.ForeignKey(AwardsNames, verbose_name='Название награды/номинации')
    ...
    fest = models.ForeignKey(FestCompetition, verbose_name='Фестиваль')
...
class Top250(models.Model):
    ...
    film = models.ForeignKey(SourceFilms, verbose_name='Фильм')
...
class ReleasesRelations(models.Model):
    ...
    release = models.ForeignKey(Releases, verbose_name='Релиз')
    rel_profile = models.ForeignKey(Profile, verbose_name='Кто связал', null=True)
    rel_dtime = models.DateTimeField(verbose_name='Когда связал', null=True)
    rel_double = models.BooleanField(verbose_name='Дубль', default=False)
    rel_ignore = models.BooleanField(verbose_name='Игнориовать', default=False)
...
class SubscriptionRelease(models.Model):
    ...
    '''
    profile = models.ForeignKey(Profile, verbose_name='Профиль пользователя')
    release = models.ForeignKey(ReleasesRelations, verbose_name='Релиз', null=True)
...
class SessionsAfishaRelations(models.Model):
    ...
    source = models.ForeignKey(ImportSources, verbose_name='Источник')
    schedule = models.ForeignKey(SourceSchedules, verbose_name='Сеанс источника')
...
class BuyTicketStatistic(models.Model):
    ...
    profile = models.ForeignKey(Profile, verbose_name='Профиль пользователя')
    session = models.ForeignKey(SourceSchedules, verbose_name='Сеанс')
...
class Projects(models.Model):
    ...
    director = models.ForeignKey(Profile, null=True)
...
class ActionsPriceList(models.Model):
    ...
    user_group = models.ForeignKey(Group, null=True, verbose_name='Группа пользователей')
    project = models.ForeignKey(Projects, verbose_name='Проект', default='1')

class PaidActions(models.Model):
    profile = models.ForeignKey(Profile, verbose_name='Профиль пользователя')
    action = models.ForeignKey(ActionsPriceList, verbose_name='Оплачиваемое действие')
    ...
    stage = models.ForeignKey(ProjectStages, verbose_name='Этап работы', null=True)
    
    future = models.BooleanField(verbose_name='Задание на будущее', default=False)
    director = models.ForeignKey(Profile, related_name="director_%(class)s", null=True, verbose_name='Профиль директора')
...
class ActionsLog(models.Model):
    ...
    site = models.ForeignKey(DjangoSite, editable=False, verbose_name='Сайт', default=1)
...
class News(models.Model):
    ...
    autor = models.ForeignKey(Profile, verbose_name='Автор', editable=False, null=True)
    site = models.ForeignKey(DjangoSite, editable=False, verbose_name='Сайт')
    ...
    language = models.ForeignKey(Language, null=True)
    translation_for = models.ForeignKey('self', null=True, related_name='translate_for_rel')
    views = models.IntegerField(verbose_name='Просмотров', default=0)

    parent = models.ForeignKey('self', null=True, related_name='parent_rel')
    branch = models.ForeignKey('self', null=True, related_name='branch_rel')
...
class NewsFilms(models.Model):
    kid = models.IntegerField(verbose_name='KID фильма', db_index=True)
    message = models.ForeignKey(News, verbose_name='Сообщение')
    source_id = models.CharField(max_length=128, verbose_name='ID источника', null=True)
    source_obj = models.ForeignKey(ImportSources, verbose_name='Источник', editable=False, null=True)
...
class NewsReaders(models.Model):
    user = models.ForeignKey(Profile, verbose_name='Связь с юзером')
...
class OrganizationMenu(models.Model):
    tag = models.ForeignKey(OrganizationTags, verbose_name='Метка')
...
class Organization(models.Model):
    ...
    creator = models.ForeignKey(Profile, verbose_name='Автор', editable=False, null=True)
    ...
    domain = models.ForeignKey(DjangoSite, editable=False, null=True)
    ...
    circuit = models.ForeignKey(CinemaCircuit, null=True)
...
class Organization_Tags(models.Model):
    organizationtags = models.ForeignKey(OrganizationTags)
    organization = models.ForeignKey(Organization)
...
class OrganizationNews(models.Model):
    news = models.ForeignKey(News)
    organization = models.ForeignKey(Organization)
    tag = models.ForeignKey(Organization_Tags, null=True)
...
class ProjectsGallery(models.Model):
    photo = models.ForeignKey(Images)
...
class ProjectsGalleryLang(models.Model):
    gallery = models.ForeignKey(ProjectsGallery)
    name = models.CharField(max_length=256, verbose_name='Название')
    title = models.CharField(max_length=128, verbose_name='Название', blank=True, null=True)
    description = models.TextField(verbose_name='Примечание', blank=True, null=True)
    language = models.ForeignKey(Language)
...
class OrgSubMenu(models.Model):
    ...
    booker_profile = models.ForeignKey(Profile, verbose_name='Связь с букером', null=True)
    

class OrgSubMenuLang(models.Model):
    orgsubmenu = models.ForeignKey(OrgSubMenu)
    name = models.CharField(max_length=256, verbose_name='Название')
    language = models.ForeignKey(Language)
...
class Background(models.Model):
    ...
    country = models.ForeignKey(Country, verbose_name='Таргетинг на страну')
    city = models.ForeignKey(City, verbose_name='Таргетинг на город', blank=True, null=True)
...
class LetsGetClients(models.Model):
    ...
    site = models.ForeignKey(DjangoSite, null=True)
...
class LetsGetCalendar(models.Model):
    ...
    site = models.ForeignKey(DjangoSite, null=True)
    subdomain = models.CharField(max_length=128, null=True)
    client = models.ForeignKey(LetsGetClients)
    bank = models.ForeignKey(LetsGetBank, default=1)
    ...
    invoice_template = models.ForeignKey(News, null=True)
    auto = models.BooleanField(default=True)
    report = models.ForeignKey(News, null=True, related_name="report_%(class)s")
...
class WithdrawMoney(models.Model):
    ...
    who = models.ForeignKey(Profile, null=True, related_name="who_%(class)s", verbose_name='Кто списывает')
    profile = models.ForeignKey(Profile, null=True, related_name="profile_%(class)s", verbose_name='У кого списывает')
    dtime = models.DateTimeField(verbose_name='Когда списавает', auto_now_add=True, editable=False)


class UserDeposit(models.Model):
    summa = models.FloatField(verbose_name='Сумма')
    profile = models.ForeignKey(Profile, null=True, verbose_name='Для кого')
...
class BannedUsersAndIPs(models.Model):
    profile = models.ForeignKey(Profile, null=True, related_name="profile_%(class)s",)
    ...
    who = models.ForeignKey(Profile, related_name="who_%(class)s", verbose_name='Кто заблокировал')
...
class Mediafiles(models.Model):
    ...
    profile = models.ForeignKey(Profile, verbose_name='Кто загрузил')
...
class SiteBanners(models.Model):
    ...
    profile = models.ForeignKey(Profile, verbose_name='Профиль - площадка', null=True)
    ...
    country = models.ForeignKey(Country, verbose_name='Страна', null=True)
    city = models.ForeignKey(City, verbose_name='Город', null=True, related_name="city_%(class)s")
    style = models.CharField(max_length=32, verbose_name='Стиль', null=True, blank=True)
    user = models.ForeignKey(Profile, verbose_name='Автор', null=True, related_name="user_%(class)s")
...
class SiteBannersClicks(models.Model):
    banner = models.ForeignKey(SiteBanners, verbose_name='Баннер', null=True)
...
class SubscriberUser(models.Model):
    ...
    profile = models.ForeignKey(Profile, verbose_name='Профиль подписчика')
    dtime = models.DateTimeField(auto_now_add=True, verbose_name='Дата, время подписки')
...
class SubscriberLog(models.Model):
    user = models.ForeignKey(SubscriberUser, verbose_name='Подписчик')
    obj = models.ForeignKey(SubscriberObjects, verbose_name='Объект')
...
class BookingSettings(models.Model):
    profile = models.ForeignKey(Profile, verbose_name='Букер')
...
class BookerCinemas(models.Model):
    ...
    settings = models.ForeignKey(BookingSettings)
...
class BookingSchedules(models.Model):
    ...
    hall = models.ForeignKey(Hall, verbose_name='Зал')
